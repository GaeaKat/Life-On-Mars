    ...
    public partial class TempWindow : Window, INotifyPropertyChanged,IDisposable
    {
        ...
        public TempWindow(Photo photo)
        {
            ...
            this.StatusText = this.kinectSensor.IsAvailable ? Life_On_Mars.Properties.Resources.RunningStatusText
                                                            : Life_On_Mars.Properties.Resources.NoSensorStatusText;
        ...
        private void ScreenshotButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                this.StatusText = string.Format(Life_On_Mars.Properties.Resources.SavedScreenshotStatusTextFormat, path);
            }
            catch (IOException)
            {
                this.StatusText = string.Format(Life_On_Mars.Properties.Resources.FailedScreenshotStatusTextFormat, path);
            }
        }
